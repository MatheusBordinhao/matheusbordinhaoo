...
const projects = [
  {
    ...
    subtitle: "TCC — Técnico em Desenvolvimento de Sistemas",
    description:
    ...
    tags: ["PHP", "JavaScript", "HTML/CSS", "SQL", "APIs", "Moodle", "WCAG", "IA"],
  ...
  {
    name: "PraViver ON",
    subtitle: "Plataforma Web de Cuidado Emocional",
    description:
    ...
    tags: ["React", "TypeScript", "C#", ".NET", "SQL", "REST API", "IA"],
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="mt-4 max-w-xl mx-auto" style={{ color: 'var(--text-muted)' }}>
            Projetos reais com impacto — cada um com um problema específico
            para resolver e tecnologias escolhidas estrategicamente.
          </p>
        </motion.div>
        ...
        <div className="flex flex-col gap-8">
          {projects.map((project, i) => (
            <motion.article
              ...
              className="group relative p-7 sm:p-9 rounded-2xl t-card hover:border-blue-500/30 transition-all duration-500 hover:shadow-[0_0_40px_rgba(37,99,235,0.08)]"
            >
              {/* Glow on hover */}
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-600/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
                  <div>
                    ...
                    <h3
                      className="text-xl sm:text-2xl font-bold group-hover:text-blue-400 transition-colors duration-300" style={{ color: 'var(--text-base)' }}>
                      {project.name}
                    </h3>
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl dark:bg-white/5 dark:border-white/10 bg-gray-100 border border-gray-200 hover:border-blue-500/30 hover:bg-blue-600/10 font-medium text-sm transition-all duration-300" style={{ color: 'var(--text-muted)' }}
          >
            <Github className="w-4 h-4" />
